...
public class TurretCommands {
	 ...
	 * // return false;
	 * return Math.abs(Turret.getTurret().getPosition() - m_angle) <
	 ...
	 * error, TurretConstants.kMinPower, TurretConstants.kMaxPower,
	 * TurretConstants.kMaxErr,
	 * TurretConstants.kTolerance);
	 ...
	 * public void execute() {
	 * Turret.getTurret()
	 * .runAtDutyCycle(MathUtil.applyDeadband(m_speed.getAsDouble(),
	 * TurretConstants.kSmallDeadzone));
	 * }
	 * // Called once the command ends or is interrupted.
	 * @Override
	 * public void end(boolean interrupted) {
