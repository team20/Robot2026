...
public abstract class Aim {
	...
	public static class Linear extends Aim {
		...
		private static final double[] s_distances = new double[] { -500, 3.17, 5.333, 6.23, 9.1, 13.1, 18, 500 }; // 2,
		// 12.5,
		// 22,
		// 500
		// };
		...
		// 360-----113-----2150------6.23
		private static final double[] s_angles = new double[] { 99, 99, 99, 113, 122, 137, 137,
				137 }; // 11, 16.8, 25, 40 + 98 ---------- // 0, 19, 37, 37 };
		private static final double[] s_velocities = new double[] { 2000, 2000, 2000, 2100, 2300, 2535, 2850, 3000 };
